...
import { constructors as CarrierBossConstructors } from './boss/CarrierBoss.js'
...
for ( let name in CarrierBossConstructors ) { addClass( name, CarrierBossConstructors[name] ) };
